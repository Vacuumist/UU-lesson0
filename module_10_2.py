...
class Knight(threading.Thread):
    ...
    def run(self):
        ...
        потока на новой строке. Без этого окончания в консоль периодически выводится информация 
        из двух потоков на одной строке, а только затем - два переноса на новую строку'''
